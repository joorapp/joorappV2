 ...
 * MasterBaseRepository
 * Abstract base class providing common CRUD operations for master data repositories
 * Master data repositories don't require context for CRUD operations
...
/**
 * Abstract base repository class for master data
 * Provides common database operations for master data entity repositories
 * Cannot be instantiated directly - must be extended by specific repository classes
 */
export class MasterBaseRepository {
  /**
   * Constructor for MasterBaseRepository
   * @param {Object} Model - Sequelize model instance
   * @param {string} entityName - Name of the entity (e.g., 'Plan', 'User')
   * @throws {Error} If attempting to instantiate MasterBaseRepository directly
   */
  constructor(Model, entityName) {
    if (new.target === MasterBaseRepository) {
      throw new Error('MasterBaseRepository is abstract and cannot be instantiated directly');
    }
  ...
  // ========================================
  // CRUD Operations (No Context Required)
  // ========================================
   ...
   * @param {string} id - Entity UUID
   * @param {Object} options - Sequelize options (transaction, deletedUserId, etc.)
  ...
  async delete(id, options = {}) {
    ...
    // For soft delete, deletedUserId can be passed in options.deletedUserId
  ...
  async bulkCreate(records, options = {}) {
    this.logger.debug(`Bulk creating ${this.entityName}`, { count: records.length });
